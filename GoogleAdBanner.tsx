...
export const GoogleAdBanner: React.FC<GoogleAdBannerProps> = ({
  ...
  format = 'auto',
  className = '',
  placementName = 'المساحة الإعلانية',
  onOpenGuide
}) => {
  ...
  return (
    <div className={`w-full max-w-5xl mx-auto my-4 px-2 sm:px-4 ${className}`} dir="rtl">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#063321] via-[#042118] to-[#063321] border border-[#d4af37]/40 shadow-xl p-3.5 sm:p-5 text-[#f5f2ed] transition-all hover:border-[#d4af37]/70">
        
        {/* Top Header: Halal Protection Badge & Report */}
        <div className="flex flex-wrap items-center justify-between gap-2 pb-2.5 mb-2.5 border-b border-[#d4af37]/20 text-xs">
          <div className="flex items-center flex-wrap gap-2">
            <span className="flex items-center gap-1.5 text-[11px] font-bold text-[#d4af37] bg-[#d4af37]/15 border border-[#d4af37]/40 px-2.5 py-1 rounded-xl shadow-xs">
              ...
              <span>إعلان مدعوم • مساحة دعوية وثقافية</span>
            </span>

            <span className="text-[10px] text-slate-300 bg-[#084d32] border border-[#d4af37]/20 px-2.5 py-0.5 rounded-lg">
              {placementName}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-[11px] text-slate-400 hover:text-rose-400 flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-[#031912] transition-colors cursor-pointer"
        ...
        <div className="relative">
          {/* Live Google AdSense <ins> Element (Rendered in DOM for Google crawlers and live serving) */}
          <div className="w-full min-h-[90px] rounded-2xl bg-[#031912]/90 border border-[#d4af37]/20 p-3 sm:p-4 flex items-center justify-center overflow-hidden">
            ...
            {/* High-Fidelity Visual Simulation Banner */}
            <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2.5 flex-shrink-0 w-full sm:w-auto justify-end">
                ...
                {onOpenGuide && (
                  <button
                    onClick={onOpenGuide}
                    title="دليل ضبط الحظر الشرعي لإعلانات Google"
        ...
        {/* Protection Note footer (Clean without publisher ID or raw code) */}
        <div className="mt-3 pt-2.5 border-t border-[#d4af37]/15 flex items-center justify-between text-[10px] text-slate-400">
